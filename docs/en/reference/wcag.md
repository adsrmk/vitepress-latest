...
* **Perceivable:** Users must be able to perceive the information being presented. This means it can't be invisible to all of their senses. For example, images need text alternatives for screen readers, and audio content needs captions for those who are hard of hearing.
