...
<div id="wizard" style="font-family:sans-serif;max-width:500px;margin:20px auto;padding:20px;border:1px solid #ccc;border-radius:8px;background:#f9f9f9;">
  <div class="step" id="step1">
    <h3>Step 1: Select your vehicle type</h3>
    <button class="choice" data-next="step2" data-choice="Motorcycle">Motorcycle</button>
    <button class="choice" data-next="step2" data-choice="Mountain Bike">Mountain Bike</button>
  </div>

  <div class="step" id="step2" style="display:none;">
    <h3>Step 2: Choose cleaning method</h3>
    <button class="choice" data-next="step3" data-choice="Spray Cleaner">Spray Cleaner</button>
    <button class="choice" data-next="step3" data-choice="Citrus Cleaner">Citrus Cleaner</button>
  </div>

  <div class="step" id="step3" style="display:none;">
    <h3>Step 3: Review your selections</h3>
    <p id="review"></p>
    <button onclick="restartWizard()" style="margin-top:10px;">Restart</button>
  </div>
</div>
...
#wizard button.choice:hover { background: #0088cc; }
#wizard button { font-size: 14px; }
</style>
