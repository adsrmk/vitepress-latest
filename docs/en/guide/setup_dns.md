...
<div id="wizard" style="font-family: sans-serif; max-width: 400px; margin: 20px; padding: 15px; border: 1px solid #ccc; border-radius: 5px;">
  <div id="step1">
    <h3>Step 1: Choose your bike type</h3>
    <button onclick="nextStep('Motorcycle')">Motorcycle</button>
    <button onclick="nextStep('Mountain Bike')">Mountain Bike</button>
  </div>

  <div id="step2" style="display:none;">
    <h3>Step 2: Select cleaning method</h3>
    <button onclick="nextStep('Spray Cleaner')">Spray Cleaner</button>
    <button onclick="nextStep('Citrus Cleaner')">Citrus Cleaner</button>
  </div>

  <div id="step3" style="display:none;">
    <h3>Step 3: Review your choices</h3>
    <p id="review"></p>
...
function nextStep(choice) {
  ...
  if (document.getElementById('step1').style.display !== 'none') {
    ...
    document.getElementById('review').innerText = 'You chose: ' + choices.join(' → ');
  }
}
